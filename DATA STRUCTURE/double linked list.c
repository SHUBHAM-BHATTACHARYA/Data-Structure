...
main()
{
    ...
    do
    {
        ...
        case 4:
            printf("Enter the element:");
            scanf("%d",&m);
            printf("Enter the position after which the element is added:");
            scanf("%d",&pos);
            break;
        case 5:
            del_beg();
        ...
        case 7:
            ...
            printf("Enter the position of item deleted:");
            scanf("%d",&pos);
            del_pos(pos);
            break;
        case 8:
...
add_after(int num,int item,int pos)
{
    struct node*tmp,*p;
    int i;
    p=start;
